...
let item1 = canvas.append("g");
    if (choice1 == "lion") {
        lion(item1, x1, y1, showOrigin, "1");
    } else if (choice1 == "trumpeter") {
        drawTrumpeter(item1, x1, y1, showOrigin, "1");
    } else if (choice1 == "fish") {
        drawFish(item1, x1, y1, showOrigin, "1");
    }  else if (choice1 == "duck") {
        drawDuck(item1, x1, y1, showOrigin, "1");
    }

let item2 = canvas.append("g");
    if (choice2 == "lion") {
        lion(item2, x2, y2, showOrigin, "2");
    } else if (choice2 == "trumpeter") {
        drawTrumpeter(item2, x2, y2, showOrigin, "2");
    } else if (choice2 == "fish") {
        drawFish(item2, x2, y2, showOrigin, "2");
    } else if (choice2 == "duck") {
        drawDuck(item2, x2, y2, showOrigin, "2");
    }
